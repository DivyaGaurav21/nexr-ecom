...
const SingleProductDetail = ({ singleProductData }) => {
    ...
    const breadCrumbs = [
        { name: "Home", url: "/" },
        {
            name: `${singleProductData?.name?.substring(0, 100)} ...`,
            url: `/products/${singleProductData?._id}`,
        },
    ];
            ...
            <section className="bg-white py-10">
                <div className="container max-w-screen-xl mx-auto px-4">
                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-8 mb-5">
                        ...
                        <main>
                            <h2 className="font-semibold text-2xl mb-4">{singleProductData?.name}</h2>
                            ...
                            <p className="mb-4 font-semibold text-xl">${singleProductData?.price}</p>
